...
export const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <header
      id="topbar"
      className="h-[74px] shrink-0 w-full bg-[#f5f7fb]/95 backdrop-blur-md border-b border-slate-200/70 px-5 sm:px-7 lg:px-8 flex items-center justify-between gap-4 sticky top-0 z-30 transition-all select-none"
    >
