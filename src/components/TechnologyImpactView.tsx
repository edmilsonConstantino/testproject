...
export const TechnologyImpactView: React.FC<TechnologyImpactViewProps> = ({
  ...
  return (
    <div id="technology-impact-view" className="w-full bg-[#F8FAFC] min-h-screen text-[#0F172A] flex flex-col">
      {/* 1. Barra Superior com Breadcrumb e Controles de Usuário */}
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <nav className="flex items-center gap-1.5 text-[13px] text-[#64748B] whitespace-nowrap overflow-hidden text-ellipsis">
              ...
              <span className="font-bold text-[#0F172A]">Tecnologia</span>
            </nav>
          </div>
          ...
          <div className="flex-1 max-w-xl mx-2 hidden md:block">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full bg-[#F1F5F9]/80 hover:bg-[#F1F5F9] focus:bg-white text-[13px] text-slate-800 placeholder:text-slate-400 pl-10 pr-14 py-2 rounded-full border border-transparent focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 transition-all outline-none"
              />
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            >
              <img
                ...
                alt="Avatar"
                className="w-8 h-8 rounded-full object-cover ring-2 ring-emerald-600/40 group-hover:ring-emerald-600 transition-all"
              />
            ...
            <section id="projetos-em-destaque-tecnologia" className="flex flex-col gap-3.5">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                ...
                <div className="lg:col-span-4 bg-white rounded-2xl border border-slate-200/80 p-4 shadow-2xs flex flex-col justify-between">
                  ...
                  {/* Lista de Regiões com Porcentagens para Tecnologia */}
                  <div className="flex flex-col gap-1 text-[11px]">
                    {[
                      { name: 'África', percent: '32%', color: 'bg-emerald-700' },
                      { name: 'América do Sul', percent: '24%', color: 'bg-emerald-600' },
                      { name: 'Ásia', percent: '20%', color: 'bg-teal-600' },
                      { name: 'Europa', percent: '16%', color: 'bg-emerald-500' },
